...
do -- tracking menu
  ...
  local menu = {
    ...
    {"-"},
    {"chests", pfQuest_Loc["Chests & Treasures"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"herbs", pfQuest_Loc["Herbs & Flowers"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"mines", pfQuest_Loc["Mines & Ores"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"fish", pfQuest_Loc["Fishing Pools"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"rares", pfQuest_Loc["Rare Mobs"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"-"},
    {"auctioneer", pfQuest_Loc["Auctioneer"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"banker", pfQuest_Loc["Banker"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"battlemaster", pfQuest_Loc["Battlemaster"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"flight", pfQuest_Loc["Flight Master"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"innkeeper", pfQuest_Loc["Innkeeper"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"mailbox", pfQuest_Loc["Mailbox"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"meetingstone", pfQuest_Loc["Meeting Stones"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"repair", pfQuest_Loc["Repair"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"spirithealer", pfQuest_Loc["Spirit Healer"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"stablemaster", pfQuest_Loc["Stable Master"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"vendor", pfQuest_Loc["Vendor"], pfDatabase and pfDatabase.TrackMeta or function() end, true},
    {"-"},
