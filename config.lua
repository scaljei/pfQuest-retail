...
pfQuestConfig.title = pfQuestConfig:CreateFontString(nil, "LOW", "GameFontNormal")
...
pfQuestConfig.close.texture = pfQuestConfig.close:CreateTexture(nil, "OVERLAY")
...
pfQuestConfig.welcome.text = pfQuestConfig.welcome:CreateFontString(nil, "LOW", "GameFontWhite")
...
pfQuestConfig.save.text = pfQuestConfig.save:CreateFontString(nil, "LOW", "GameFontWhite")
...
do -- welcome/init popup dialog
  ...
  -- welcome title
  pfQuestInit.title = pfQuestInit:CreateFontString(nil, "LOW", "GameFontWhite")
  ...
  for i, button in pairs(buttons) do
    ...
    pfQuestInit[i].caption = pfQuestInit:CreateFontString(nil, "LOW", "GameFontWhite")
  ...
  pfQuestInit.checkbox.caption = pfQuestInit:CreateFontString(nil, "LOW", "GameFontWhite")
  ...
  pfQuestInit.save.text = pfQuestInit.save:CreateFontString(nil, "LOW", "GameFontWhite")
