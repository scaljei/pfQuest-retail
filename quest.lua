...
function pfQuest:AddQuestLogIntegration()
  ...
  pfQuest.buttonOnline.txt:SetFont(STANDARD_TEXT_FONT or "Fonts\\FRIZQT__.TTF", 11, "")
  ...
  pfQuest.buttonLanguage.txt:SetFont(STANDARD_TEXT_FONT or "Fonts\\FRIZQT__.TTF", 11, "")
