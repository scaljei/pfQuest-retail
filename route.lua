...
pfQuest.route.arrow.model = pfQuest.route.arrow:CreateTexture(nil, "ARTWORK")
...
pfQuest.route.arrow.title = pfQuest.route.arrow:CreateFontString(nil, "OVERLAY")
...
pfQuest.route.arrow.description = pfQuest.route.arrow:CreateFontString(nil, "OVERLAY")
...
pfQuest.route.arrow.distance = pfQuest.route.arrow:CreateFontString(nil, "OVERLAY")
